...
export const FETCH_PHONES_FAILURES = 'FETCH_PHONES_FAILURES';

export const LOAD_MORE_PHONES_START = 'LOAD_MORE_PHONES_START';
export const LOAD_MORE_PHONES_SUCCESS = 'LOAD_MORE_PHONES_SUCCESS';
export const LOAD_MORE_PHONES_FAILURES = 'LOAD_MORE_PHONES_FAILURES';
...
export const FETCH_PHONE_BY_ID_FAILURES = 'FETCH_PHONE_BY_ID_FAILURES';
